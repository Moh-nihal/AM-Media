...
const Packages = () => {
  ...
  return (
    ...
    >
      {/* Background - website colors, black shades in dark mode (no violet) */}
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <div className="relative rounded-2xl overflow-hidden
            ...
            <div className="p-6 sm:p-8 md:p-10 pl-8 sm:pl-10">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-500 to-rose-500 flex items-center justify-center flex-shrink-0">
                    <Icon className="w-7 h-7 text-white" />
                  </div>
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-display font-bold text-stone-900 dark:text-white">
                      {pkg.name}
                    </h3>
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl sm:text-4xl font-display font-bold bg-gradient-to-r from-indigo-600 to-rose-600 dark:from-indigo-400 dark:to-rose-400 bg-clip-text text-transparent">
                    {pkg.price}
                  </span>
                  {pkg.price !== 'Custom' && (
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between pt-4 border-t border-stone-200 dark:border-indigo-400/10">
                <motion.button
