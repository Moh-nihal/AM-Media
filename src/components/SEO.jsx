...
export default function SEO({ title, description, name, type, image, url }) {
    const defaultTitle = "AJMALMUKHTAR - Your Idea Matters!";
    const defaultDescription = "Professional web design, branding, and development services by Ajmal Mukhtar.";
    ...
    const seoTitle = title ? `${title} | AJMALMUKHTAR` : defaultTitle;
